...
export const AuditAction = {
  ...
  MOVIE_OPEN_TO_ALL: 'MOVIE_OPEN_TO_ALL',
  ...
  // Privilege changes. Without these, "who made this person an admin" and "who removed that
  // account" are unanswerable — the questions an append-only trail exists to answer.
  ...
  AUDITORIUM_UPDATE: 'AUDITORIUM_UPDATE',
  SEAT_ALLOCATION_SET: 'SEAT_ALLOCATION_SET',
} as const;
